...
function insertWorkItem(database: { prepare(sql: string): { run(...values: unknown[]): unknown } }): void {
  database
    .prepare(
    ...
    .run("work_1", "org_1", "github", "github.pull_request", "42", "Billing export", "merged", "github_pull_request");
}
